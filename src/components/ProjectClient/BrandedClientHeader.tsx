...
const BrandedClientHeader: React.FC<BrandedClientHeaderProps> = ({
  ...
  return <div className="relative overflow-hidden bg-white shadow-sm">
      {/* Top Navigation Bar */}
      ...
      background: `linear-gradient(135deg, ${primaryColor}08 0%, ${secondaryColor}08 100%)`
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-[51px]">
          <div className="text-center space-y-6">
            
            {/* Logo */}
            <div className="flex justify-center">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl shadow-lg flex items-center justify-center" style={{
              backgroundColor: 'white'
            }}>
                {branding?.logo_url ? <img src={branding.logo_url} alt={branding.freelancer_name || 'Freelancer Logo'} className="w-16 h-16 sm:w-20 sm:h-20 object-contain rounded-xl" /> : <User className="w-10 h-10 sm:w-12 sm:h-12" style={{
                color: primaryColor
              }} />}
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              {branding?.freelancer_title && <div className="flex justify-center">
              ...
              {branding?.freelancer_bio && <p className="text-slate-600 text-lg max-w-2xl mx-auto leading-relaxed">
