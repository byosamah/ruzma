        ...
        <div className="flex items-start justify-between">
          ...
          <DropdownMenu open={isActionsOpen} onOpenChange={setIsActionsOpen}>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-white/95 backdrop-blur-sm">
              ...
              {onDeleteClick && <DropdownMenuItem onClick={handleDelete} className="flex items-center text-red-600">
  ...
  return <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" onClick={handleCopyClientLink} className="bg-white/80 border-slate-200 hover:bg-white text-slate-700">
            <Copy className="w-4 h-4 mr-2" />
            Copy Link
          </Button>
          <Button variant="outline" onClick={handleSendClientLink} className="bg-white/80 border-slate-200 hover:bg-white text-slate-700">
            <Send className="w-4 h-4 mr-2" />
            Send Link
          </Button>
          <Button variant="outline" onClick={handleViewClientPage} className="bg-white/80 border-slate-200 hover:bg-white text-slate-700">
            <ExternalLink className="w-4 h-4 mr-2" />
            Preview
          </Button>
          <Button variant="outline" onClick={onEditClick} className="bg-white/80 border-slate-200 hover:bg-white text-slate-700">
            <Edit className="w-4 h-4 mr-2" />
            Edit
          </Button>
          {onDeleteClick && <Button variant="outline" onClick={onDeleteClick} className="bg-white/80 border-red-200 hover:bg-red-50 text-red-600 hover:text-red-700">
      ...
      <div className="bg-white/60 rounded-xl p-4 border border-white/40">
        ...
        <div className="w-full bg-slate-200 rounded-full h-3">
          <div className="bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full transition-all duration-500 ease-out" style={{
