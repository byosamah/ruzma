  ...
  <section className="relative overflow-x-clip bg-white pt-14 pb-16 md:pb-28">
    ...
    <div className="container mx-auto px-5 md:px-10 flex flex-col items-center">
      ...
      <p className="max-w-2xl text-center text-base md:text-lg text-brand-navy opacity-80 mb-7">
        Ruzma empowers freelancers and agencies to manage client work, share progress, and get paid—in one secure client portal. Impress clients with clarity, automate tasks, and deliver projects without stress.
      </p>
      ...
      <span className="text-xs text-brand-navy/60 font-medium">No credit card required</span>
      {/* Product screenshot */}
      <div className="relative mt-10 md:mt-16 w-full max-w-3xl rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        <img
          ...
          alt="Client Project Portal UI"
          className="w-full object-cover h-[260px] md:h-[350px] bg-white"
          style={{ objectPosition: "top center" }}
        />
        <span className="absolute top-3 right-6 text-xs font-semibold bg-white/70 rounded-full px-4 py-1 text-brand-black border border-brand-yellow shadow-sm">
