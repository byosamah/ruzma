...
const integrations = [
  ...
  { icon: <Mail className="w-10 h-10 text-orange-400" />, name: "Email" },
...
const IntegrationsSection = () => (
  <section id="integrations" className="py-14 px-3 bg-brand-black">
    <div className="container mx-auto flex flex-col items-center">
      <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-6">Integrate with the best in-class tools</h2>
