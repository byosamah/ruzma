export const CURRENCIES_EXPANDED = {
...
// Update the Supabase edge function to include expanded currencies
export const SUPPORTED_CURRENCIES_API = [
  // Major Currencies
...
// Keep the existing CURRENCIES export for backward compatibility
export const CURRENCIES = CURRENCIES_EXPANDED;

export type CurrencyCode = keyof typeof CURRENCIES;

// Utility functions with expanded support
...
// Enhanced country-currency mapping
