...
import { createAuthSlice, AuthSlice } from './slices/authSlice.v2';
...
/**
 * Create the root store with dependency injection
 */
    ...
    subscribeWithSelector(
      persist(
        immer((set, get, store) => {
          ...
          return {
            // Inject services into slices
            ...createAuthSlice(authService)(set, get, store),
            ...createUISlice(set, get, store),
            ...createProjectSlice(set, get, store), // Will be updated to use projectService
