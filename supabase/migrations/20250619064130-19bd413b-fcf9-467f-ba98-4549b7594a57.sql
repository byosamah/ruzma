...
-- Fix the check_user_limits function to be secure
...
-- Fix the update_project_count function to be secure
...
-- Fix the update_user_storage function to be secure
CREATE OR REPLACE FUNCTION public.update_user_storage(_user_id uuid, _size_change bigint)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public, pg_temp
